...
<section>
  <ol>
    <li>Purpose of the Website: Our Website provides information on holiday apartments available for rent, including their pricing and availability. This Website also provides links to other websites that may be of interest to you.</li>

    <li>Use of the Website: You may use the Website only for lawful purposes and in accordance with the Terms. You agree not to use the Website:
      <ul>
        ...
        <li>To transmit, or obtain the sending of, any advertising or promotional material, including any "junk mail," "chain letter," "spam," or any other similar solicitation.</li>
        <li>To impersonate or attempt to impersonate another person or entity.</li>
      </ul>
    </li>
    <li>Disclaimer of Warranties: Our Website is provided “as is” and “as available” without any warranty of any kind, either express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
    </li>
    <li>Limitation of Liability: In no event shall we be liable for any damages arising from the use of the Website, including but not limited to indirect, incidental, special, punitive, or consequential damages, loss of profits, or data, or loss of goodwill.
    </li>
    <li>
    ...
    <li>
    Changes to the Terms: We reserve the right to modify these Terms at any time without prior notice. Your continued use of the Website after any such changes constitutes your acceptance of the new Terms.
    </li>
...
<section>
  ...
  <p>We would like to take this opportunity to extend our gratitude to all the developers who are involved in these projects and make them available.</p>
  <p>The original license terms for the software used can be found at the following links:</p>
  <ul>
    <li>MIT License: <a target="_bank" rel="noreferrer noopener" href="https://opensource.org/licenses/MIT">https://opensource.org/licenses/MIT</a></li>
