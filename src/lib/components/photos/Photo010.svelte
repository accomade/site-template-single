			...
			<script lang="ts">
				...
				import { src as placeholder, width, height } from '../../../../photos/010.jpg?w=40&metadata'
				...
				const importFormats = async () => {
					let srcsetAvif = (await import('../../../../photos/010.jpg?w=300;500;700;900;1100;2000;2600;3200;4000&format=avif&srcset')).default;
					let srcsetWebp = (await import('../../../../photos/010.jpg?w=300;500;700;900;1100;2000;2600;3200;4000&format=webp&srcset')).default;
